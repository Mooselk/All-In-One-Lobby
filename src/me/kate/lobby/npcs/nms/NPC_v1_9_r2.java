...
public class NPC_v1_9_r2 implements NPC {

    private static List<NPC_v1_9_r2> npcs = new ArrayList<NPC_v1_9_r2>();
    ...
    public static void startTask(Plugin plugin){
        if(!taskstarted){
            taskstarted = true;
            NPC_v1_9_r2.plugin = plugin;
            Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
                @Override
                public void run() {
                    for(NPC_v1_9_r2 nmsnpc : npcs){
    ...
    public NPC_v1_9_r2(Location location, NPCSkin skin){
        npcid = id++;
        this.skin = skin;
    ...
    private void spawnEnttity(Player p){
        ...
        Bukkit.getScheduler().runTaskLater(NPC_v1_9_r2.plugin, new Runnable(){
            @Override
            public void run() {
