...
public class NPC_v1_11_r1 implements NPC {
    ...
    private static List<NPC_v1_11_r1> npcs = new ArrayList<NPC_v1_11_r1>();
    ...
    public static void startTask(Plugin plugin){
        if(!taskstarted){
            taskstarted = true;
            NPC_v1_11_r1.plugin = plugin;
            Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, new Runnable() {
                @Override
                public void run() {
                    for(NPC_v1_11_r1 nmsnpc : npcs){
    ...
    public NPC_v1_11_r1(Location location, NPCSkin skin){
        npcid = id++;
        this.skin = skin;
    ...
    private void spawnEnttity(Player p){
        ...
        Bukkit.getScheduler().runTaskLater(NPC_v1_11_r1.plugin, new Runnable(){
            @Override
            public void run() {
